    ...
    return (
      <div>
        <h2 id="student-heading">
          <Translate contentKey="virtualClassroomApp.student.home.title">Students</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="virtualClassroomApp.student.home.createLabel">Create new Student</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('virtualClassroomApp.student.home.search')}
                  />
