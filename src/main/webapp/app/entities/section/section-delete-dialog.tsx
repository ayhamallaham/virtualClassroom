  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="virtualClassroomApp.section.delete.question">
          <Translate contentKey="virtualClassroomApp.section.delete.question" interpolate={{ id: sectionEntity.id }}>
