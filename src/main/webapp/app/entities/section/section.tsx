    ...
    return (
      <div>
        <h2 id="section-heading">
          <Translate contentKey="virtualClassroomApp.section.home.title">Sections</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="virtualClassroomApp.section.home.createLabel">Create new Section</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('virtualClassroomApp.section.home.search')}
                  />
