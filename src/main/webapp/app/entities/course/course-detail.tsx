  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="virtualClassroomApp.course.detail.title">Course</Translate> [<b>{courseEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{courseEntity.studyGroup ? courseEntity.studyGroup.id : ''}</dd>
          </dl>
