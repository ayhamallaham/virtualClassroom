    ...
    return (
      <div>
        <h2 id="course-heading">
          <Translate contentKey="virtualClassroomApp.course.home.title">Courses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="virtualClassroomApp.course.home.createLabel">Create new Course</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('virtualClassroomApp.course.home.search')}
                  />
